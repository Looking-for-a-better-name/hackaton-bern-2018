module.exports = [
  ...
  { dmg: 'Unknown people sprayed the facade.', desc: '' },
  {
  ...
  { dmg: 'Spreyerei', desc: '' },
  { dmg: 'Storm Deep Friederike Damaged 2 Stores', desc: '' },
  { dmg: 'Spayerei', desc: '' },
  {
  ...
  { dmg: 'storm blew away brick \\', desc: ' ' },
  {
  ...
  {
    dmg: 'Stores endommagés par la grêle',
  ...
  { dmg: 'flooding', desc: '' },
  { dmg: 'water interruption', desc: '' },
  { dmg: 'The tenant, Mr. Brian, has informed us that he has discovered 2 wasp nests.', desc: '' },
  {
  ...
  { dmg: 'graffiti on facade', desc: 'painter was commissioned' },
  {
  ...
  { dmg: '3206', desc: 'Replacement was commissioned. ' },
  {
    dmg: 'storm with strong wind and hail against the west facade',
    desc: ''
  },
  { dmg: 'Heavy thunderstorm with hailstorm', desc: '' },
  { dmg: 'water pushed through chimney', desc: '' },
  { dmg: 'glass breakage', desc: '' },
  {
