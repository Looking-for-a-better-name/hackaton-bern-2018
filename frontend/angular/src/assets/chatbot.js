...
function insertBotMessage(obj) {
    ...
    setTimeout(function () {
        $('.message.loading:last-of-type').replaceWith('<div class="message new"><figure class="avatar"><img src="./assets/images/bat.png" /></figure>' + obj.text + '</div>');
...
function showLink(text) {
    $('<div class="message new"><figure class="avatar"><img src="./assets/images/bat.png" /></figure>' + text + '</div>').appendTo($('.mCSB_container'));
    updateScrollbar();
}
...
function setloading() {
    ...
    if ($('.message.loading').length == 0) {
        $('<div class="message loading new"><figure class="avatar"><img src="./assets/images/bat.png" /></figure><span></span></div>').appendTo($('.mCSB_container'));
        updateScrollbar();
    }
}
